...
public class JobMapAdapter extends RecyclerView.Adapter<JobMapAdapter.MyViewHolder> {

    private List<JobNewItem> mWorkItems;
    private Context context;
    private OnClickItem clickItem;

    public JobMapAdapter(Context context, List<JobNewItem> mWorkItems, OnClickItem clickItem) {

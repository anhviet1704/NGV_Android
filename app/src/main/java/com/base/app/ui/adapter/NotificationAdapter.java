...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.MyViewHolder> {
    ...
    public NotificationAdapter(Context context, List<WorkItem> mWorkItems, OnClickItem clickItem) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tvStatus.setText(mWorkItem.getValue());
        ...
        //Glide.with(context).load(url).apply(NGVUtils.onGetRound(6)).into(holder.ivIcon);
